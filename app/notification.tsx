...
import { configurePushNotifications, sendLocalNotification } from '../lib/notification';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} tintColor="#5E72E4" />}
      >
        {notifications.length === 0 ? (
